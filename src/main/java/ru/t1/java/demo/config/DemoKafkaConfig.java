...
public class DemoKafkaConfig<T> {
    ...
    @Value("${t1.kafka.heartbeat.interval}")
    ...
    @Bean
    ConcurrentKafkaListenerContainerFactory<String, AccountDto> accountListenerContainerFactory(@Qualifier("accountListenerFactory") ConsumerFactory<String, AccountDto> consumerFactory) {
    ...
    @Bean
    ConcurrentKafkaListenerContainerFactory<String, TransactionDto> transactionListenerContainerFactory(@Qualifier("transactionListenerFactory") ConsumerFactory<String, TransactionDto> consumerFactory) {
    ...
    @Bean
    @Primary
    public KafkaTemplate<String, T> kafkaLogTemplate(ProducerFactory<String, T> producerPatFactory) {
